            ...
            <div class="main-content">
				<div class="container-fluid">
                        <div class="panel">
								...
								<form action="<?php echo base_url(). 'index.php/Welcome/tambahsolusi'; ?>" method="post" enctype="multipart/form-data">
									<div class="panel-body">									
									    ...
									    <br>
											<label>Solusi</label>
									    	<input type="text" name="solusi" class="form-control" placeholder="">
										<br>
